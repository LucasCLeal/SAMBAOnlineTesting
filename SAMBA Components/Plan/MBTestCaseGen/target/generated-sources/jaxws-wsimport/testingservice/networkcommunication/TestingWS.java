...
public interface TestingWS {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "exeTestInstruction", targetNamespace = "http://networkCommunication.testingService/", className = "testingservice.networkcommunication.ExeTestInstruction")
    @ResponseWrapper(localName = "exeTestInstructionResponse", targetNamespace = "http://networkCommunication.testingService/", className = "testingservice.networkcommunication.ExeTestInstructionResponse")
    public boolean exeTestInstruction(
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "resetTestVariables", targetNamespace = "http://networkCommunication.testingService/", className = "testingservice.networkcommunication.ResetTestVariables")
    @ResponseWrapper(localName = "resetTestVariablesResponse", targetNamespace = "http://networkCommunication.testingService/", className = "testingservice.networkcommunication.ResetTestVariablesResponse")
